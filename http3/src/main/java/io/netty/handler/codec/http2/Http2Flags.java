...
public final class Http2Flags {
  ...
  /**
   * Determines whether the flag is set indicating the presence of the exclusive, stream dependency,
   * and weight fields in a HEADERS frame.
   */
  ...
  /**
   * Gets the number of bytes expected for the priority fields of the payload. This is determined by
   * the {@link #priorityPresent()} flag.
   */
