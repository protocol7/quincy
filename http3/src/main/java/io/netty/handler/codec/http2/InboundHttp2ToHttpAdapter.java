...
public class InboundHttp2ToHttpAdapter extends Http2EventAdapter {
    ...
    protected InboundHttp2ToHttpAdapter(final Http2Connection connection, final int maxContentLength,
                                        final boolean validateHttpHeaders, final boolean propagateSettings) {
     ...
     */
    protected void fireChannelRead(final ChannelHandlerContext ctx, final FullHttpMessage msg, final boolean release,
     ...
     */
    protected FullHttpMessage newMessage(final Http2Stream stream, final Http2Headers headers, final boolean validateHttpHeaders,
     ...
     */
    protected FullHttpMessage processHeadersBegin(final ChannelHandlerContext ctx, final Http2Stream stream, final Http2Headers headers,
                                                  final boolean endOfStream, final boolean allowAppend, final boolean appendToTrailer) throws Http2Exception {
     ...
     */
    private void processHeadersEnd(final ChannelHandlerContext ctx, final Http2Stream stream, final FullHttpMessage msg,
    ...
    public void onPushPromiseRead(final ChannelHandlerContext ctx, final int streamId, final int promisedStreamId,
        ...
        final FullHttpMessage msg = processHeadersBegin(ctx, promisedStream, headers, false, false, false);
        if (msg == null) {
