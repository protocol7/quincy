...
public class DefaultHttp2Connection implements Http2Connection {
    ...
    @Override
    public void goAwayReceived(final int lastKnownStream, final long errorCode, final ByteBuf debugData) throws Http2Exception {
    ...
    @Override
    public boolean goAwaySent(final int lastKnownStream, final long errorCode, final ByteBuf debugData) throws Http2Exception {
    ...
    static State activeState(final int streamId, final State initialState, final boolean isLocal, final boolean halfClosed)
    ...
    private class DefaultStream implements Http2Stream {
        ...
        private class PropertyMap {
            ...
            <V> V add(final DefaultPropertyKey key, final V value) {
                ...
                @SuppressWarnings("unchecked") final V prevValue = (V) values[key.index];
    ...
    private final class DefaultEndpoint<F extends Http2FlowController> implements Endpoint<F> {
        ...
        private void checkNewStreamAllowed(final int streamId, final State state) throws Http2Exception {
            assert state != IDLE;
