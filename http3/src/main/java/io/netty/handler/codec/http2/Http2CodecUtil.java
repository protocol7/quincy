...
public final class Http2CodecUtil {
     ...
     */
    public static void writeFrameHeader(final ByteBuf out, final int payloadLength, final byte type,
                                        final Http2Flags flags, final int streamId) {
     ...
     */
    public static void headerListSizeExceeded(final int streamId, final long maxHeaderListSize,
                                              final boolean onDecode) throws Http2Exception {
    ...
    static void writeFrameHeaderInternal(final ByteBuf out, final int payloadLength, final byte type,
                                         final Http2Flags flags, final int streamId) {
