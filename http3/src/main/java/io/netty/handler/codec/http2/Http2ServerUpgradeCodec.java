...
public class Http2ServerUpgradeCodec implements HttpServerUpgradeHandler.UpgradeCodec {
    ...
    private Http2ServerUpgradeCodec(final String handlerName, final Http2ConnectionHandler connectionHandler,
    ...
    @Override
    public boolean prepareUpgradeResponse(final ChannelHandlerContext ctx, final FullHttpRequest upgradeRequest,
     ...
     */
    private Http2Settings decodeSettingsHeader(final ChannelHandlerContext ctx, final CharSequence settingsHeader)
