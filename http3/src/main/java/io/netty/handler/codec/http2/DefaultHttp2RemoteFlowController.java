...
public class DefaultHttp2RemoteFlowController implements Http2RemoteFlowController {
    ...
    private int maxUsableChannelBytes() {
        ...
        final int channelWritableBytes = (int) min(Integer.MAX_VALUE, ctx.channel().bytesBeforeUnwritable());
        final int usableBytes = channelWritableBytes > 0 ? max(channelWritableBytes, minUsableChannelBytes()) : 0;
