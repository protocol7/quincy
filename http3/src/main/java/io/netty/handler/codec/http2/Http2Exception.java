...
public class Http2Exception extends Exception {
     ...
     * @return An exception which can be translated into a HTTP/2 error.
     */
    public static Http2Exception connectionError(final Http2Error error, final Throwable cause,
     ...
     * Otherwise the error is considered a connection error and a {@link Http2Exception} is returned.
     */
    public static Http2Exception streamError(final int id, final Http2Error error, final Throwable cause,
                                             final String fmt, final Object... args) {
        return CONNECTION_STREAM_ID == id ?
     ...
     * returned.
     */
    public static Http2Exception headerListSizeError(final int id, final Http2Error error, final boolean onDecode,
                                                     final String fmt, final Object... args) {
        return CONNECTION_STREAM_ID == id ?
                Http2Exception.connectionError(error, fmt, args) :
