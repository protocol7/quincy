 ...
 *   <li>{@link #headerSensitivityDetector(SensitivityDetector)}
...
public abstract class AbstractHttp2ConnectionHandlerBuilder<
  ...
  private static final SensitivityDetector DEFAULT_HEADER_SENSITIVITY_DETECTOR =
  ...
  protected B headerSensitivityDetector(final SensitivityDetector headerSensitivityDetector) {
