...
public class HttpToHttp2ConnectionHandler extends Http2ConnectionHandler {
    ...
    protected HttpToHttp2ConnectionHandler(final Http2ConnectionDecoder decoder, final Http2ConnectionEncoder encoder,
                                           final Http2Settings initialSettings, final boolean validateHeaders) {
    ...
    private static void writeHeaders(final ChannelHandlerContext ctx, final Http2ConnectionEncoder encoder, final int streamId,
                                     final HttpHeaders headers, final Http2Headers http2Headers, final boolean endStream,
                                     final SimpleChannelPromiseAggregator promiseAggregator) {
