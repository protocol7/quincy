...
public class InboundHttpToHttp2Adapter extends ChannelInboundHandlerAdapter {
    ...
    static void handle(final ChannelHandlerContext ctx, final Http2Connection connection,
                       final Http2FrameListener listener, final FullHttpMessage message) throws Http2Exception {
        try {
