 ...
 * all writes of buffered streams will fail with a {@link Http2ChannelClosedException}. In the
 * second case, all writes of buffered streams with an identifier less than the last stream
 * identifier of the GO_AWAY frame will fail with a {@link Http2GoAwayException}.
 *
...
public class Http2FrameCodec extends Http2ConnectionHandler {
  ...
  static class DefaultHttp2FrameStream implements Http2FrameStream {
    ...
    DefaultHttp2FrameStream setStreamAndProperty(
        final PropertyKey streamKey, final Http2Stream stream) {
