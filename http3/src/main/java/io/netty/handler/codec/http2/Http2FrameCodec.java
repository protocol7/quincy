...
public class Http2FrameCodec extends Http2ConnectionHandler {
    ...
    private void writeHeadersFrame(
            final ChannelHandlerContext ctx, final Http2HeadersFrame headersFrame, final ChannelPromise promise) {
    ...
    protected void onConnectionError(
            final ChannelHandlerContext ctx, final boolean outbound, final Throwable cause, final Http2Exception http2Ex) {
        if (!outbound) {
     ...
     */
    @Override
    protected final void onStreamError(final ChannelHandlerContext ctx, final boolean outbound, final Throwable cause,
    ...
    void onHttp2UnknownStreamError(@SuppressWarnings("unused") final ChannelHandlerContext ctx, final Throwable cause,
                                   final Http2Exception.StreamException streamException) {
        // Just log....
    ...
    private final class FrameListener implements Http2FrameListener {
        ...
        public void onUnknownFrame(
                final ChannelHandlerContext ctx, final byte frameType, final int streamId, final Http2Flags flags, final ByteBuf payload) {
        ...
        public void onHeadersRead(final ChannelHandlerContext ctx, final int streamId,
                                  final Http2Headers headers, final int streamDependency, final short weight, final boolean
                                          exclusive, final int padding, final boolean endStream) {
        ...
        public void onPriorityRead(
                final ChannelHandlerContext ctx, final int streamId, final int streamDependency, final short weight, final boolean exclusive) {
        ...
        public void onPushPromiseRead(
                final ChannelHandlerContext ctx, final int streamId, final int promisedStreamId, final Http2Headers headers, final int padding)  {
            // TODO: Maybe handle me
        }
    ...
    void onHttp2StreamWritabilityChanged(final ChannelHandlerContext ctx, final Http2FrameStream stream,
    ...
    static class DefaultHttp2FrameStream implements Http2FrameStream {
        ...
        DefaultHttp2FrameStream setStreamAndProperty(final PropertyKey streamKey, final Http2Stream stream) {
