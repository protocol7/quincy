...
public class Http2FrameCodecBuilder extends
    ...
    public Http2FrameCodec build() {
        ...
        if (frameWriter != null) {
            ...
            final Http2ConnectionDecoder decoder = new DefaultHttp2ConnectionDecoder(connection, encoder, frameReader,
    ...
    protected Http2FrameCodec build(
            final Http2ConnectionDecoder decoder, final Http2ConnectionEncoder encoder, final Http2Settings initialSettings) {
        final Http2FrameCodec codec = new Http2FrameCodec(encoder, decoder, initialSettings, decoupleCloseAndGoAway());
