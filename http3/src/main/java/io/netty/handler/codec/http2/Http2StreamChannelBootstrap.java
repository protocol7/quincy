...
public final class Http2StreamChannelBootstrap {
    ...
    private static void setChannelOptions(
            final Channel channel, final Map<ChannelOption<?>, Object> options, final InternalLogger logger) {
    ...
    private static void setChannelOption(
            final Channel channel, final ChannelOption<?> option, final Object value, final InternalLogger logger) {
        try {
