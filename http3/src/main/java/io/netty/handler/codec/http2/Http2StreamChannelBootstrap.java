...
public final class Http2StreamChannelBootstrap {
  private static final InternalLogger logger =
      InternalLoggerFactory.getInstance(Http2StreamChannelBootstrap.class);
  ...
  /**
   * Allow to specify a {@link ChannelOption} which is used for the {@link Http2StreamChannel}
   * instances once they got created. Use a value of {@code null} to remove a previous set {@link
   * ChannelOption}.
   */
  ...
  /**
   * Allow to specify an initial attribute of the newly created {@link Http2StreamChannel}. If the
   * {@code value} is {@code null}, the attribute of the specified {@code key} is removed.
   */
  @SuppressWarnings("unchecked")
  ...
  public void open0(final ChannelHandlerContext ctx, final Promise<Http2StreamChannel> promise) {
    ...
    final Http2StreamChannel streamChannel =
        ((Http2MultiplexCodec) ctx.handler()).newOutboundStream();
    try {
      init(streamChannel);
  ...
  private static void setChannelOption(
    ...
    try {
      ...
      logger.warn(
          "Failed to set channel option '{}' with value '{}' for channel '{}'",
          option,
          value,
          channel,
          t);
