...
public class Http2ClientUpgradeCodec implements HttpClientUpgradeHandler.UpgradeCodec {
    ...
    private Http2ClientUpgradeCodec(final String handlerName, final Http2ConnectionHandler connectionHandler, final ChannelHandler
                                    upgradeToHandler) {
    ...
    @Override
    public Collection<CharSequence> setUpgradeHeaders(final ChannelHandlerContext ctx,
