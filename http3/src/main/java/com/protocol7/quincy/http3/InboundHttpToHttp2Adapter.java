...
public class InboundHttpToHttp2Adapter extends ChannelInboundHandlerAdapter {
  ...
  public InboundHttpToHttp2Adapter(
  ...
  static void handle(
    ...
    try {
      ...
      message
          .headers()
          .set(HttpConversionUtil.ExtensionHeaderNames.SCHEME.text(), HttpScheme.HTTP.name());
      ...
      if (hasTrailers) {
        final Http2Headers headers =
            HttpConversionUtil.toHttp2Headers(message.trailingHeaders(), true);
