...
/**
 * Signifies that the <a href="https://tools.ietf.org/html/rfc7540#section-3.5">connection
 * preface</a> and the initial SETTINGS frame have been sent. The client sends the preface, and the
 * server receives the preface. The client shouldn't write any data until this event has been
 * processed.
 */
@UnstableApi
