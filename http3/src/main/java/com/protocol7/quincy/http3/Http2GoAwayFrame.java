 ...
 * relative {@link #extraStreamIds()} should be used. The {@link #lastStreamId()} will only be set
 * for incoming GOAWAY frames by the HTTP/2 codec.
 *
 * <p>Graceful shutdown as described in the HTTP/2 spec can be accomplished by calling {@code
