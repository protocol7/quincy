...
import static com.protocol7.quincy.http3.Http2CodecUtil.CONTINUATION_FRAME_HEADER_LENGTH;
import static com.protocol7.quincy.http3.Http2CodecUtil.DATA_FRAME_HEADER_LENGTH;
...
import static com.protocol7.quincy.http3.Http2CodecUtil.GO_AWAY_FRAME_HEADER_LENGTH;
import static com.protocol7.quincy.http3.Http2CodecUtil.HEADERS_FRAME_HEADER_LENGTH;
import static com.protocol7.quincy.http3.Http2CodecUtil.INT_FIELD_LENGTH;
import static com.protocol7.quincy.http3.Http2CodecUtil.MAX_UNSIGNED_BYTE;
import static com.protocol7.quincy.http3.Http2CodecUtil.MAX_UNSIGNED_INT;
...
import static com.protocol7.quincy.http3.Http2CodecUtil.PRIORITY_FRAME_LENGTH;
import static com.protocol7.quincy.http3.Http2CodecUtil.PUSH_PROMISE_FRAME_HEADER_LENGTH;
import static com.protocol7.quincy.http3.Http2CodecUtil.RST_STREAM_FRAME_LENGTH;
import static com.protocol7.quincy.http3.Http2CodecUtil.SETTING_ENTRY_LENGTH;
import static com.protocol7.quincy.http3.Http2CodecUtil.WINDOW_UPDATE_FRAME_LENGTH;
import static com.protocol7.quincy.http3.Http2CodecUtil.isMaxFrameSizeValid;
import static com.protocol7.quincy.http3.Http2CodecUtil.verifyPadding;
import static com.protocol7.quincy.http3.Http2CodecUtil.writeFrameHeaderInternal;
  ...
  public void maxFrameSize(final int max) throws Http2Exception {
    if (!isMaxFrameSizeValid(max)) {
      throw connectionError(
          ...
          "Invalid MAX_FRAME_SIZE specified in sent settings: %d",
          max);
    }
    maxFrameSize = max;
  }
