...
public class DefaultHttp2HeadersEncoder
  ...
  public DefaultHttp2HeadersEncoder(
      final SensitivityDetector sensitivityDetector, final boolean ignoreMaxHeaderListSize) {
  ...
  public DefaultHttp2HeadersEncoder(
      ...
      final int dynamicTableArraySizeHint) {
  ...
  DefaultHttp2HeadersEncoder(
      final SensitivityDetector sensitivityDetector, final HpackEncoder hpackEncoder) {
  ...
  @Override
  public void encodeHeaders(final int streamId, final Http2Headers headers, final ByteBuf buffer)
    ...
    try {
      ...
      throw connectionError(
          Http2Error.COMPRESSION_ERROR, t, "Failed encoding headers block: %s", t.getMessage());
    }
  }
