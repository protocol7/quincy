 ...
 * cases, the {@link #stream()} must return {@code null}. If the frame applies to a stream, the
 * {@link Http2FrameStream#id()} must be greater than zero.
 */
@UnstableApi
public interface Http2StreamFrame extends Http2Frame {
  ...
  /**
   * Returns the {@link Http2FrameStream} object for this frame, or {@code null} if the frame has
   * yet to be associated with a stream.
   */
