...
public interface Http2DataWriter {
  /**
   * Writes a {@code DATA} frame to the remote endpoint. This will result in one or more frames
   ...
   *     between 0 and 256 (inclusive). A 1 byte padding is encoded as just the pad length field
   *     with value 0. A 256 byte padding is encoded as the pad length field with value 255 and 255
   *     padding bytes appended to the end of the frame.
