...
@UnstableApi
public final class DefaultHttp2UnknownFrame extends DefaultByteBufHolder
  ...
  public DefaultHttp2UnknownFrame(
      final byte frameType, final Http2Flags flags, final ByteBuf data) {
    super(data);
