...
public final class HttpToHttp2ConnectionHandlerBuilder
    extends AbstractHttp2ConnectionHandlerBuilder<
        HttpToHttp2ConnectionHandler, HttpToHttp2ConnectionHandlerBuilder> {
  ...
  @Override
  public HttpToHttp2ConnectionHandlerBuilder gracefulShutdownTimeoutMillis(
  ...
  @Override
  public HttpToHttp2ConnectionHandlerBuilder codec(
  ...
  @Override
  public HttpToHttp2ConnectionHandlerBuilder initialHuffmanDecodeCapacity(
      final int initialHuffmanDecodeCapacity) {
    return super.initialHuffmanDecodeCapacity(initialHuffmanDecodeCapacity);
  }

  @Override
  public HttpToHttp2ConnectionHandlerBuilder decoupleCloseAndGoAway(
  ...
  protected HttpToHttp2ConnectionHandler build(
    ...
    return new HttpToHttp2ConnectionHandler(
        decoder, encoder, initialSettings, isValidateHeaders(), decoupleCloseAndGoAway());
  }
}
