...
public interface Http2ConnectionEncoder extends Http2FrameWriter {
  ...
  /**
   * Sets the lifecycle manager. Must be called as part of initialization before the encoder is
   * used.
   */
  ...
  /**
   * Writes the given data to the internal {@link Http2FrameWriter} without performing any state
   * checks on the connection/stream.
   */
  @Override
