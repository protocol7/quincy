...
public class UniformStreamByteDistributorTest {
  ...
  @Mock private StreamByteDistributor.Writer writer;

  @Before
  public void setup() throws Http2Exception {
    MockitoAnnotations.initMocks(this);

    stateMap = new IntObjectHashMap<Http2TestUtil.TestStreamByteDistributorStreamState>();
  ...
  private Answer<Void> writeAnswer() {
    return new Answer<Void>() {
      ...
      public Void answer(final InvocationOnMock in) throws Throwable {
        ...
        final Http2TestUtil.TestStreamByteDistributorStreamState state = stateMap.get(stream.id());
  ...
  public void minChunkShouldBeAllocatedPerStream() throws Http2Exception {
    ...
    final int written = 3 * CHUNK_SIZE;
  ...
  private void initState(
    ...
    final Http2TestUtil.TestStreamByteDistributorStreamState state =
        new Http2TestUtil.TestStreamByteDistributorStreamState(
            stream, pendingBytes, hasFrame, isWriteAllowed);
    stateMap.put(streamId, state);
    distributor.updateStreamableBytes(state);
  }

  private void setPriority(
      final int streamId, final int parent, final int weight, final boolean exclusive) {
  ...
  private int captureWrite(final int streamId) {
