...
public class Http2ConnectionRoundtripTest {
  ...
  public void teardown() throws Exception {
    ...
    final Future<?> serverGroup = sb.config().group().shutdownGracefully(0, 5, SECONDS);
    final Future<?> serverChildGroup = sb.config().childGroup().shutdownGracefully(0, 5, SECONDS);
    final Future<?> clientGroup = cb.config().group().shutdownGracefully(0, 5, SECONDS);
  ...
  public void inflightFrameAfterStreamResetShouldNotMakeConnectionUnusable() throws Exception {
    ...
    doAnswer(
            new Answer<Void>() {
              ...
              public Void answer(final InvocationOnMock invocationOnMock) throws Throwable {
                final ChannelHandlerContext ctx = invocationOnMock.getArgument(0);
                http2Server
                    .encoder()
                    .writeHeaders(
                        ctx,
    ...
    Http2TestUtil.runInChannel(
        clientChannel,
        new Http2TestUtil.Http2Runnable() {
          @Override
          public void run() throws Http2Exception {
            http2Client
                .encoder()
                .writeHeaders(ctx(), 3, headers, 0, weight, false, 0, false, newPromise());
            http2Client.flush(ctx());
            http2Client
                .encoder()
                .writeRstStream(ctx(), 3, Http2Error.INTERNAL_ERROR.code(), newPromise());
            http2Client.flush(ctx());
          }
        });
    ...
    Http2TestUtil.runInChannel(
        ...
        new Http2TestUtil.Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            http2Client
                .encoder()
                .writeHeaders(ctx(), 5, headers, 0, weight, false, 0, false, newPromise());
            http2Client.flush(ctx());
          }
        });
  ...
  public void headersWithEndStreamShouldNotSendError() throws Exception {
    ...
    Http2TestUtil.runInChannel(
        ...
        new Http2TestUtil.Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            http2Client
                .encoder()
                .writeHeaders(ctx(), 3, headers, 0, weight, false, 0, true, newPromise());
            http2Client.flush(ctx());
          }
        });
    ...
    verify(serverListener, never())
        .onGoAwayRead(any(ChannelHandlerContext.class), anyInt(), anyLong(), any(ByteBuf.class));
    verify(serverListener, never())
        .onRstStreamRead(any(ChannelHandlerContext.class), anyInt(), anyLong());
  ...
  public void encodeViolatesMaxHeaderListSizeCanStillUseConnection() throws Exception {
    ...
    final AtomicReference<Throwable> clientHeadersWriteException2 =
    ...
    doAnswer(
        ...
        .when(serverListener)
        .onSettingsAckRead(any(ChannelHandlerContext.class));
    doAnswer(
            new Answer<Void>() {
              @Override
              public Void answer(final InvocationOnMock invocationOnMock) throws Throwable {
        ...
        .when(clientListener)
        .onSettingsRead(any(ChannelHandlerContext.class), any(Http2Settings.class));
    ...
    // Set the maxHeaderListSize to 100 so we may be able to write some headers, but not all. We
    // want to verify
          ...
          public void run() throws Http2Exception {
            http2Server
                ...
                .writeSettings(
                    serverCtx(),
                    new Http2Settings()
                        .copyFrom(http2Server.decoder().localSettings())
    ...
    Http2TestUtil.runInChannel(
        ...
        new Http2TestUtil.Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            http2Client
                .encoder()
                .writeHeaders(ctx(), 3, headers, 0, false, newPromise())
                .addListener(
            ...
            // It is expected that this write should fail locally and the remote peer will never see
            // this.
            http2Client
                .encoder()
                .writeData(ctx(), 3, Unpooled.buffer(), 0, true, newPromise())
                .addListener(
                    new ChannelFutureListener() {
                      @Override
                      public void operationComplete(final ChannelFuture future) throws Exception {
    ...
    assertNotNull(
        "Header encode should have exceeded maxHeaderListSize!", clientHeadersWriteException.get());
    ...
    Http2TestUtil.runInChannel(
        ...
        new Http2TestUtil.Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            http2Client
                .encoder()
                .writeHeaders(ctx(), 5, headers, 0, true, newPromise())
                .addListener(
                    new ChannelFutureListener() {
                      @Override
                      public void operationComplete(final ChannelFuture future) throws Exception {
  ...
  public void testSettingsAckIsSentBeforeUsingFlowControl() throws Exception {
    ...
    doAnswer(
            new Answer<Integer>() {
              @Override
              public Integer answer(final InvocationOnMock in) throws Throwable {
                final ByteBuf buf = (ByteBuf) in.getArguments()[2];
                final int padding = (Integer) in.getArguments()[3];
                final int processedBytes = buf.readableBytes() + padding;
    ...
    // The client should now attempt to send data, but the window size is 0 so it will be queued in
    // the flow
    // controller.
    Http2TestUtil.runInChannel(
        clientChannel,
        new Http2TestUtil.Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            ...
            http2Client
                .encoder()
                .writeData(ctx(), 3, Unpooled.wrappedBuffer(data), 0, true, newPromise());
            http2Client.flush(ctx());
  ...
  public void priorityUsingHigherValuedStreamIdDoesNotPreventUsingLowerStreamId() throws Exception {
    ...
    verify(serverListener)
        .onPriorityRead(any(ChannelHandlerContext.class), eq(5), eq(3), eq((short) 14), eq(false));
    verify(serverListener)
        .onHeadersRead(
            any(ChannelHandlerContext.class),
            eq(3),
  ...
  public void headersUsingHigherValuedStreamIdPreventsUsingLowerStreamId() throws Exception {
    ...
    Http2TestUtil.runInChannel(
        ...
        new Http2TestUtil.Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            http2Client
                .encoder()
                .writeHeaders(ctx(), 5, headers, 0, (short) 16, false, 0, false, newPromise());
            http2Client
                .encoder()
                .frameWriter()
                .writeHeaders(ctx(), 3, headers, 0, (short) 16, false, 0, false, newPromise());
    ...
    // Client should receive a RST_STREAM for stream 3, but there is not Http2Stream object so the
    // listener is never
    // notified.
    verify(serverListener, never())
        .onGoAwayRead(any(ChannelHandlerContext.class), anyInt(), anyLong(), any(ByteBuf.class));
  ...
  public void headersWriteForPeerStreamWhichWasResetShouldNotGoAway() throws Exception {
    ...
    Http2TestUtil.runInChannel(
        ...
        new Http2TestUtil.Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            ...
            http2Client
                .encoder()
                .writeRstStream(ctx(), streamId, Http2Error.CANCEL.code(), newPromise());
            http2Client.flush(ctx());
          }
        });
    ...
    doAnswer(
        ...
        .when(serverListener)
        .onRstStreamRead(any(ChannelHandlerContext.class), eq(streamId), anyLong());
    ...
    Http2TestUtil.runInChannel(
        ...
        new Http2TestUtil.Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            http2Server
                .encoder()
                .writeHeaders(serverCtx(), streamId, headers, 0, true, serverNewPromise())
                .addListener(
                    new ChannelFutureListener() {
                      @Override
                      public void operationComplete(final ChannelFuture future) throws Exception {
    ...
    final Throwable serverWriteHeadersCause = serverWriteHeadersCauseRef.get();
  ...
  public void writeOfEmptyReleasedBufferSingleBufferTrailersQueuedInFlowControllerShouldFail()
      throws Exception {
    writeOfEmptyReleasedBufferQueuedInFlowControllerShouldFail(
        WriteEmptyBufferMode.SINGLE_WITH_TRAILERS);
  }
  ...
  public void writeOfEmptyReleasedBufferMultipleBuffersQueuedInFlowControllerShouldFail()
      throws Exception {
    writeOfEmptyReleasedBufferQueuedInFlowControllerShouldFail(
        WriteEmptyBufferMode.SECOND_END_OF_STREAM);
  }
  ...
  public void writeOfEmptyReleasedBufferMultipleBuffersTrailersQueuedInFlowControllerShouldFail()
      throws Exception {
    writeOfEmptyReleasedBufferQueuedInFlowControllerShouldFail(
        WriteEmptyBufferMode.SECOND_WITH_TRAILERS);
  }

  private void writeOfEmptyReleasedBufferQueuedInFlowControllerShouldFail(
      final WriteEmptyBufferMode mode) throws Exception {
    bootstrapEnv(1, 1, 2, 1);
          ...
          public void run() throws Http2Exception {
            http2Client
                ...
                .writeHeaders(
                    ...
                    false,
                    newPromise());
            final ByteBuf emptyBuf = Unpooled.buffer();
            emptyBuf.release();
            switch (mode) {
                ...
                .addFirst(
                    new ChannelOutboundHandlerAdapter() {
                      ...
                      public void write(
                        ...
                        // Ensure we update the window size so we will try to write the rest of the
                        // frame while
  ...
  public void noMoreStreamIdsShouldSendGoAway() throws Exception {
        ...
        new Http2TestUtil.Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            http2Client
                .encoder()
                .writeHeaders(
                    ctx(), MAX_VALUE + 1, headers, 0, (short) 16, false, 0, true, newPromise());
            http2Client.flush(ctx());
          }
        });
    ...
    verify(serverListener)
        .onGoAwayRead(
            any(ChannelHandlerContext.class),
            eq(0),
            ArgumentMatchers.eq(Http2Error.PROTOCOL_ERROR.code()),
            any(ByteBuf.class));
  }
  ...
  public void createStreamAfterReceiveGoAwayShouldNotSendGoAway() throws Exception {
        ...
        new Http2TestUtil.Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            http2Server
                .encoder()
                .writeGoAway(
                    serverCtx(), 3, Http2Error.NO_ERROR.code(), EMPTY_BUFFER, serverNewPromise());
            http2Server.flush(serverCtx());
          }
        });
    ...
    final AtomicReference<ChannelFuture> clientWriteAfterGoAwayFutureRef =
        new AtomicReference<ChannelFuture>();
        ...
        new Http2TestUtil.Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            final ChannelFuture f =
                http2Client
                    .encoder()
                    .writeHeaders(ctx(), 5, headers, 0, (short) 16, false, 0, true, newPromise());
    ...
    final ChannelFuture clientWriteAfterGoAwayFuture = clientWriteAfterGoAwayFutureRef.get();
    assertNotNull(clientWriteAfterGoAwayFuture);
    final Throwable clientCause = clientWriteAfterGoAwayFuture.cause();
    assertThat(clientCause, is(instanceOf(Http2Exception.StreamException.class)));
    assertEquals(
        Http2Error.REFUSED_STREAM.code(),
        ((Http2Exception.StreamException) clientCause).error().code());
              ...
              public Void answer(final InvocationOnMock invocationOnMock) throws Throwable {
                final ChannelFuture f =
                    http2Client
                        .encoder()
                        .writeHeaders(
                            ctx(), 5, headers, 0, (short) 16, false, 0, true, newPromise());
                clientWriteAfterGoAwayFutureRef.set(f);
                f.addListener(
                    new ChannelFutureListener() {
                      @Override
  ...
  public void flowControlProperlyChunksLargeMessage() throws Exception {
    ...
    try {
      ...
      Http2TestUtil.runInChannel(
          ...
          new Http2TestUtil.Http2Runnable() {
            ...
            public void run() throws Http2Exception {
              ...
              http2Client
                  .encoder()
                  .writeData(ctx(), 3, data.retainedDuplicate(), 0, false, newPromise());
      ...
      out.flush();
      final byte[] received = out.toByteArray();
  ...
  public void stressTest() throws Exception {
    ...
    doAnswer(
        ...
        .when(serverListener)
        .onPingRead(any(ChannelHandlerContext.class), any(Long.class));
    ...
    doAnswer(
            new Answer<Integer>() {
              @Override
              public Integer answer(final InvocationOnMock in) throws Throwable {
                final int streamId = (Integer) in.getArguments()[1];
                final ByteBuf buf = (ByteBuf) in.getArguments()[2];
                final int padding = (Integer) in.getArguments()[3];
                final int processedBytes = buf.readableBytes() + padding;

                final int streamIndex = (streamId - 3) / 2;
    ...
    try {
      ...
      Http2TestUtil.runInChannel(
          ...
          new Http2TestUtil.Http2Runnable() {
            @Override
            public void run() throws Http2Exception {
              final int upperLimit = 3 + 2 * numStreams;
              for (int streamId = 3; streamId < upperLimit; streamId += 2) {
                ...
                http2Client
                    .encoder()
                    .writeData(ctx(), streamId, data.retainedSlice(), 0, false, newPromise());
                // Write trailers.
                http2Client
                    .encoder()
                    .writeHeaders(
      ...
      for (final StringBuilder builder : receivedData) {
        assertEquals(dataAsHex, builder.toString());
      }
      for (final long receivedPing : receivedPings) {
  ...
  private void bootstrapEnv(
      final int dataCountDown,
      final int settingsAckCount,
      final int requestCountDown,
      final int trailersCountDown)
      throws Exception {
  ...
  private void bootstrapEnv(
    ...
    final AtomicReference<Http2ConnectionHandler> serverHandlerRef =
        new AtomicReference<Http2ConnectionHandler>();
          ...
          protected void initChannel(final Channel ch) throws Exception {
            ...
            serverFrameCountDown =
                new Http2TestUtil.FrameCountDown(
                    serverListener,
                    serverSettingsAckLatch,
                    requestLatch,
                    dataLatch,
                    trailersLatch,
                    goAwayLatch);
            serverHandlerRef.set(
    ...
    final ChannelFuture ccf = cb.connect(serverChannel.localAddress());
  ...
  private static Http2Headers dummyHeaders() {
    return new DefaultHttp2Headers(false)
        ...
        .add(Http2TestUtil.randomString(), Http2TestUtil.randomString());
  }

  private static void mockFlowControl(final Http2FrameListener listener) throws Http2Exception {
    doAnswer(
            new Answer<Integer>() {
              @Override
              public Integer answer(final InvocationOnMock invocation) throws Throwable {
                final ByteBuf buf = (ByteBuf) invocation.getArguments()[2];
                final int padding = (Integer) invocation.getArguments()[3];
                final int processedBytes = buf.readableBytes() + padding;
                return processedBytes;
              }
            })
  ...
  private static void setGracefulShutdownTime(
      final Channel channel, final Http2ConnectionHandler handler, final long millis)
  ...
  private static ByteBuf randomBytes(final int length) {
