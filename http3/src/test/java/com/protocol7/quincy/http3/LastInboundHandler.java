...
public class LastInboundHandler extends ChannelDuplexHandler {
  ...
  private static final Consumer<Object> NOOP_CONSUMER =
      new Consumer<Object>() {
        @Override
  ...
  public LastInboundHandler(final Consumer<ChannelHandlerContext> channelReadCompleteConsumer) {
    this.channelReadCompleteConsumer =
        checkNotNull(channelReadCompleteConsumer, "channelReadCompleteConsumer");
  }
  ...
  public void channelInactive(final ChannelHandlerContext ctx) throws Exception {
    if (!channelActive) {
      throw new IllegalStateException(
          "channelInactive may only be fired once after channelActive.");
    }
    channelActive = false;
