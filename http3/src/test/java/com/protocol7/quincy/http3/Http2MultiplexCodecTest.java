...
import com.protocol7.quincy.http3.LastInboundHandler.Consumer;
...
public class Http2MultiplexCodecTest {
  ...
  public void setUp() {
    ...
    verify(frameWriter).writeSettingsAck(eqMultiplexCodecCtx(), Http2TestUtil.anyChannelPromise());
    ...
    verify(frameWriter)
        .writeSettings(
            eqMultiplexCodecCtx(),
            Http2TestUtil.anyHttp2Settings(),
            Http2TestUtil.anyChannelPromise());
  }
  ...
  public void headerAndDataFramesShouldBeDelivered() {
    ...
    final Http2DataFrame dataFrame1 =
        new DefaultHttp2DataFrame(Http2TestUtil.bb("hello")).stream(channel.stream());
    final Http2DataFrame dataFrame2 =
        new DefaultHttp2DataFrame(Http2TestUtil.bb("world")).stream(channel.stream());
  ...
  public void framesShouldBeMultiplexed() {
    ...
    frameInboundWriter.writeInboundData(
        channel2.stream().id(), Http2TestUtil.bb("hello"), 0, false);
  ...
  public void inboundDataFrameShouldUpdateLocalFlowController() throws Http2Exception {
    ...
    final ByteBuf tenBytes = Http2TestUtil.bb("0123456789");
  ...
  public void channelReadShouldRespectAutoRead() {
    ...
    frameInboundWriter.writeInboundData(
        childChannel.stream().id(), Http2TestUtil.bb("hello world"), 0, false);
    final Http2DataFrame dataFrame0 = inboundHandler.readInbound();
    assertNotNull(dataFrame0);
    release(dataFrame0);

    frameInboundWriter.writeInboundData(
        childChannel.stream().id(), Http2TestUtil.bb("foo"), 0, false);
    frameInboundWriter.writeInboundData(
        childChannel.stream().id(), Http2TestUtil.bb("bar"), 0, false);
  ...
  private void useReadWithoutAutoRead(final boolean readComplete) {
    ...
    frameInboundWriter.writeInboundData(
        childChannel.stream().id(), Http2TestUtil.bb("foo"), 0, false);
    frameInboundWriter.writeInboundData(
        childChannel.stream().id(), Http2TestUtil.bb("bar"), 0, true);
  ...
  public void endOfStreamDoesNotDiscardData() {
    ...
    final Http2DataFrame dataFrame1 =
        new DefaultHttp2DataFrame(Http2TestUtil.bb("1")).stream(childChannel.stream());
    final Http2DataFrame dataFrame2 =
        new DefaultHttp2DataFrame(Http2TestUtil.bb("2")).stream(childChannel.stream());
    final Http2DataFrame dataFrame3 =
        new DefaultHttp2DataFrame(Http2TestUtil.bb("3")).stream(childChannel.stream());
    final Http2DataFrame dataFrame4 =
        new DefaultHttp2DataFrame(Http2TestUtil.bb("4")).stream(childChannel.stream());
    ...
    frameInboundWriter.writeInboundData(
        childChannel.stream().id(), Http2TestUtil.bb("1"), 0, false);
    ...
    frameInboundWriter.writeInboundData(
        childChannel.stream().id(), Http2TestUtil.bb("2"), 0, false);
    frameInboundWriter.writeInboundData(
        childChannel.stream().id(), Http2TestUtil.bb("3"), 0, false);
    frameInboundWriter.writeInboundData(
        childChannel.stream().id(), Http2TestUtil.bb("4"), 0, false);
