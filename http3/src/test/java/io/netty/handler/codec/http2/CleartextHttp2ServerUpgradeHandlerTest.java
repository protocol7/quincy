...
public class CleartextHttp2ServerUpgradeHandlerTest {
    ...
    private void setUpServerChannel() {
        ...
        final CleartextHttp2ServerUpgradeHandler handler = new CleartextHttp2ServerUpgradeHandler(
    ...
    public void downgrade() throws Exception {
        ...
        final String requestString = "GET / HTTP/1.1\r\n" +
                         "Host: example.com\r\n\r\n";
        final ByteBuf inbound = Unpooled.buffer().writeBytes(requestString.getBytes(CharsetUtil.US_ASCII));
