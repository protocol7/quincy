...
public class Http2ServerUpgradeCodecTest {
  ...
  private static void testUpgrade(final Http2ConnectionHandler handler) {
    ...
    final Http2ServerUpgradeCodec codec = new Http2ServerUpgradeCodec("connectionHandler", handler);
