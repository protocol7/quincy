...
public class DefaultHttp2FrameReaderTest {
    ...
    private void writeHeaderFrame(
            final ByteBuf output, final int streamId, final Http2Headers headers,
            final Http2Flags flags) throws Http2Exception {
    ...
    private void writeHeaderFrameWithData(
            final ByteBuf output, final int streamId, final Http2Headers headers,
            final ByteBuf dataPayload) throws Http2Exception {
        final ByteBuf headerBlock = Unpooled.buffer();
        try {
            hpackEncoder.encodeHeaders(streamId, headerBlock, headers, Http2HeadersEncoder.NEVER_SENSITIVE);
    ...
    private void writeHeaderFramePriorityPresent(
            final ByteBuf output, final int streamId, final Http2Headers headers,
            final Http2Flags flags, final int streamDependency, final int weight) throws Http2Exception {
        final ByteBuf headerBlock = Unpooled.buffer();
        try {
