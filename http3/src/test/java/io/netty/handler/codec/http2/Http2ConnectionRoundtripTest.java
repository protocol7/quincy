...
public class Http2ConnectionRoundtripTest {
  ...
  public void noMoreStreamIdsShouldSendGoAway() throws Exception {
    ...
    verify(serverListener)
        .onGoAwayRead(
            any(ChannelHandlerContext.class), eq(0), eq(PROTOCOL_ERROR.code()), any(ByteBuf.class));
  }
  ...
  public void createStreamAfterReceiveGoAwayShouldNotSendGoAway() throws Exception {
    ...
    runInChannel(
        ...
        new Http2Runnable() {
          ...
          public void run() throws Http2Exception {
            http2Server
                .encoder()
                .writeGoAway(serverCtx(), 3, NO_ERROR.code(), EMPTY_BUFFER, serverNewPromise());
            http2Server.flush(serverCtx());
          }
        });
    ...
    verify(clientListener)
        .onGoAwayRead(
            any(ChannelHandlerContext.class), eq(3), eq(NO_ERROR.code()), any(ByteBuf.class));
