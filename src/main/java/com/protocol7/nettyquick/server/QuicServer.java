...
public class QuicServer {
  ...
  public static QuicServer bind(final InetSocketAddress address) {
    return new QuicServer(address);
  }
  ...
  private QuicServer(final InetSocketAddress address) {
    ...
    System.out.printf("Binding to ", address);
