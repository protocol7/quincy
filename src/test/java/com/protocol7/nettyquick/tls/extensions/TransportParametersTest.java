...
public class TransportParametersTest {
  ...
  public void parseKnown() {
    byte[] data =
        Hex.dehex(
            "0000006508000000655a6a9a1a004f0000000480008000000a000480008000000b000480008000000100048000c000000200024064000800024064000300011e0005000245ac00090000000600102a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a");
