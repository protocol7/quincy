...
public class HandshakeAEADTest {
  ...
  public void testKnownTls() {
    final byte[] sharedSecret =
        dehex("df4a291baa1eb7cfa6934b29b474baad2697e29f1f920dcc77c8a0a088447624");
    final byte[] helloHash =
        dehex("da75ce1139ac80dae4044da932350cf65c97ccc9e33f1e6f7d2d4b18b736ffd5");

    final byte[] handshakeSecret = HKDF.calculateHandshakeSecret(sharedSecret);

    final AEAD aead = HandshakeAEAD.create(handshakeSecret, helloHash, true);
